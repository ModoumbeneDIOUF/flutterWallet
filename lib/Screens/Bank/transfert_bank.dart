...
class TransfertBank extends StatefulWidget {
  final String operationType;

  const TransfertBank({Key? key, required this.operationType})
      : super(key: key);

  @override
  _TransfertBankState createState() => _TransfertBankState();
}

class _TransfertBankState extends State<TransfertBank> {
                                            ...
                                            Future.delayed(Duration(seconds: 2))
                                              ...
                                              progressDialog!
                                                  ...
                                                  .then((value) => setState(() {
                                                      Navigator.push(
                                                         context,
                                                         MaterialPageRoute(builder: (context) => SuccessScren()));
